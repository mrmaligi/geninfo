import {
  ...
  __privateMethod,
  __publicField
} from "./chunk-74S3BVK6.js";

// node_modules/@tailwindcss/browser/dist/index.global.js
(() => {
  var _Je_instances, r_fn, e_fn, t_fn, _a;
  var Gt = "4.1.11";
  var Pe = 92, We = 47, qe = 42, Yt = 34, Zt = 39, Uo = 58, Ge = 59, ne = 10, Ye = 13, Oe = 32, He = 9, Jt = 123, bt = 125, At = 40, Qt = 41, Do = 91, zo = 93, Xt = 45, yt = 64, Ko = 33;
  function Ne(t, r) {
    let o = (r == null ? void 0 : r.from) ? { file: r.from, code: t } : null;
    t[0] === "\uFEFF" && (t = " " + t.slice(1));
    let e = [], i = [], s = [], a = null, f = null, u = "", c = "", p = 0, m;
    for (let g = 0; g < t.length; g++) {
      let v = t.charCodeAt(g);
      if (!(v === Ye && (m = t.charCodeAt(g + 1), m === ne))) if (v === Pe) u === "" && (p = g), u += t.slice(g, g + 2), g += 1;
      else if (v === We && t.charCodeAt(g + 1) === qe) {
        let k = g;
        for (let y = g + 2; y < t.length; y++) if (m = t.charCodeAt(y), m === Pe) y += 1;
        ...
        if (v === ne) {
          ...
          let k = "", x = g, y = -1;
          for (let b = g + 2; b < t.length; b++) if (m = t.charCodeAt(b), m === Pe) b += 1;
          else if (m === Zt || m === Yt) b = er(t, b, m);
          else if (m === We && t.charCodeAt(b + 1) === qe) {
            for (let V = b + 2; V < t.length; V++) if (m = t.charCodeAt(V), m === Pe) V += 1;
          ...
          if (c = c.slice(0, -1), u.length > 0) if (u.charCodeAt(0) === yt) f = _e(u), o && (f.src = [o, p, g], f.dst = [o, p, g]), a ? a.nodes.push(f) : e.push(f), u = "", f = null;
          else {
            let x = u.indexOf(":");
            if (a) {
              let y = xt(u, x);
  ...
  function er(t, r, o) {
    let e;
    for (let i = r + 1; i < t.length; i++) if (e = t.charCodeAt(i), e === Pe) i += 1;
    else {
      if (e === o) return i;
  ...
  var rr = /* @__PURE__ */ new Map([["--font", ["--font-weight", "--font-size"]], ["--inset", ["--inset-shadow", "--inset-ring"]], ["--text", ["--text-color", "--text-decoration-color", "--text-decoration-thickness", "--text-indent", "--text-shadow", "--text-underline-offset"]]]);
  function tr(t, r) {
    return (rr.get(r) ?? []).some((o) => t === o || t.startsWith(`${o}-`));
  }
  var Je = (_a = class {
    constructor(r = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Set([])) {
    ...
    getOptions(r) {
      var _a2;
      return r = ve(__privateMethod(this, _Je_instances, r_fn).call(this, r)), ((_a2 = this.values.get(r)) == null ? void 0 : _a2.options) ?? 0;
    }
    entries() {
    ...
    markUsedVariable(r) {
      let o = ve(__privateMethod(this, _Je_instances, r_fn).call(this, r)), e = this.values.get(o);
      if (!e) return false;
      let i = e.options & 16;
      return e.options |= 16, !i;
    }
    resolve(r, o, e = 0) {
      let i = __privateMethod(this, _Je_instances, e_fn).call(this, r, o);
      if (!i) return null;
      let s = this.values.get(i);
      return (e | s.options) & 1 ? s.value : __privateMethod(this, _Je_instances, t_fn).call(this, i);
    }
    resolveValue(r, o) {
      let e = __privateMethod(this, _Je_instances, e_fn).call(this, r, o);
    ...
    resolveWith(r, o, e = []) {
      ...
      for (let f of e) {
        ...
        c && (c.options & 1 ? s[f] = c.value : s[f] = __privateMethod(this, _Je_instances, t_fn).call(this, u));
      }
      let a = this.values.get(i);
      return a.options & 1 ? [a.value, s] : [__privateMethod(this, _Je_instances, t_fn).call(this, i), s];
    }
    namespace(r) {
      let o = /* @__PURE__ */ new Map(), e = `${r}-`;
  ...
  }, _Je_instances = new WeakSet(), r_fn = function(r) {
    return this.prefix ? `--${r.slice(3 + this.prefix.length)}` : r;
  }, e_fn = function(r, o) {
    for (let e of o) {
      let i = r !== null ? `${e}-${r}` : e;
      if (!this.values.has(i)) if (r !== null && r.includes(".")) {
  ...
  var or = 92, Io = 41, ir = 58, nr = 44, Fo = 34, lr = 61, ar = 62, sr = 60, ur = 10, Mo = 40, Bo = 39, cr = 47, fr = 32, dr = 9;
  function q(t) {
    t = t.replaceAll(`\r
`, `
`);
    ...
    for (let a = 0; a < t.length; a++) {
      ...
      switch (f) {
        ...
        case dr: {
          ...
          let u = a, c = a + 1;
          for (; c < t.length && (s = t.charCodeAt(c), !(s !== ir && s !== nr && s !== lr && s !== ar && s !== sr && s !== ur && s !== cr && s !== fr && s !== dr)); c++) ;
          a = c - 1;
          let p = jo(t.slice(u, c));
        ...
        case Fo: {
          let u = a;
          for (let c = a + 1; c < t.length; c++) if (s = t.charCodeAt(c), s === or) c += 1;
          else if (s === f) {
            a = c;
            break;
          }
        ...
        case Io: {
          ...
          if (i.length > 0) {
            let c = Nt(i);
            u == null ? void 0 : u.nodes.push(c), i = "";
          }
  ...
  function j(t, r, o = [], e = {}) {
    for (let i = 0; i < t.length; i++) {
      ...
      o.push(s);
      let f = false, u = 0, c = r(s, { parent: a, context: e, path: o, replaceWith(p) {
        f || (f = true, Array.isArray(p) ? p.length === 0 ? (t.splice(i, 1), u = 0) : p.length === 1 ? (t[i] = p[0], u = 1) : (t.splice(i, 1, ...p), u = p.length) : (t[i] = p, u = 1));
      } }) ?? 0;
      if (o.pop(), f) {
        c === 0 ? i-- : i += u - 1;
        continue;
  ...
  function be(t, r, o = 3) {
    let e = [], i = /* @__PURE__ */ new Set(), s = new W(() => /* @__PURE__ */ new Set()), a = new W(() => /* @__PURE__ */ new Set()), f = /* @__PURE__ */ new Set(), u = /* @__PURE__ */ new Set(), c = [], p = [], m = new W(() => /* @__PURE__ */ new Set());
    function g(k, x, y = {}, $ = 0) {
      if (k.kind === "declaration") {
        ...
        if (k.value.includes("var(")) if (y.theme && k.property[0] === "-" && k.property[1] === "-") for (let b of Qe(k.value)) m.get(b).add(k.property);
        else r.trackUsedVariables(k.value);
        if (k.property === "animation") for (let b of pr(k.value)) u.add(b);
        o & 2 && k.value.includes("color-mix(") && a.get(x).add(k), x.push(k);
      } else if (k.kind === "rule") if (k.selector === "&") for (let b of k.nodes) {
        let V = [];
      ...
      } else if (k.kind === "at-root") for (let b of k.nodes) {
        let V = [];
        g(b, V, y, 0);
        ...
        for (let b of k.nodes) g(b, x, { ...y, ...k.context }, $);
      } else k.kind === "comment" && x.push(k);
    }
    let v = [];
    for (let k of t) g(k, v, {}, 0);
    e: for (let [k, x] of s) for (let y of x) {
      if (mr(y.property, r.theme, m)) {
        if (y.property.startsWith(r.theme.prefixKey("--animate-"))) for (let V of pr(y.value)) u.add(V);
        continue;
      }
      let b = k.indexOf(y);
    ...
    for (let k of f) if (!u.has(k.params)) {
      let x = e.indexOf(k);
      e.splice(x, 1);
    }
    if (v = v.concat(e), o & 2) for (let [k, x] of a) for (let y of x) {
      let $ = k.indexOf(y);
      ...
      if (ee(b, (P, { replaceWith: D }) => {
        ...
        let _ = false, H = false;
        if (ee(P.nodes, (L, { replaceWith: B }) => {
          if (L.kind == "word" && L.value.toLowerCase() === "currentcolor") {
            H = true, V = true;
            return;
          }
          let J = L, ie = null, n = /* @__PURE__ */ new Set();
          do {
            ...
            if (n.add(h), V = true, ie = r.theme.resolveValue(null, [d.value]), !ie) {
              _ = true;
              return;
            }
      ...
      let R = { ...y, value: Z(b) }, K = G("@supports (color: color-mix(in lab, red, red))", [y]);
...
`, r) {
          o += c.length;
          let p = o;
          o += a.property.length, o += 2, o += ((_a2 = a.value) == null ? void 0 : _a2.length) ?? 0, a.important && (o += 11);
          let m = o;
          o += 2, a.dst = [e, p, m];
        }
      } else if (a.kind === "rule") {
...
`, r) {
  ...
  function mr(t, r, o, e = /* @__PURE__ */ new Set()) {
    if (e.has(t) || (e.add(t), r.getOptions(t) & 24)) return true;
    {
      let s = o.get(t) ?? [];
      for (let a of s) if (mr(a, r, o, e)) return true;
    }
    return false;
  }
  function pr(t) {
    ...
    for (let s = 0; s < t.length; s++) {
      ...
      if (a >= 48 && a <= 57 || e !== null && (a === 37 || a >= 97 && a <= 122 || a >= 65 && a <= 90) ? e = s : (i = e, e = null), a === 40) {
        ...
        if ((a === 43 || a === 42 || a === 47 || a === 45) && o[0]) {
          let f = r.trimEnd(), u = f.charCodeAt(f.length - 1), c = f.charCodeAt(f.length - 2), p = t.charCodeAt(s + 1);
  ...
  function* wr(t, r) {
    ...
    if (a[0] === "[") {
      ...
      let v = a.slice(0, g), k = ge(a.slice(g + 1));
      if (!fe(k)) return;
    ...
    if (a[a.length - 1] === "]") {
      ...
      let g = a.slice(0, m);
      if (!r.utilities.has(g, "functional")) return;
      let v = a.slice(m + 2, -1), k = U(v, ":"), x = null;
      if (k.length === 2 && (x = k[0], v = k[1]), v[0] !== "-" || v[1] !== "-" || !fe(v)) return;
      p = [[g, x === null ? `[var(${v})]` : `[${x}:var(${v})]`]];
    } else p = yr(a, (m) => r.utilities.has(m, "functional"));
    for (let [m, g] of p) {
      let v = { kind: "functional", root: m, modifier: c, value: null, variants: i, important: s, raw: t };
      if (g === null) {
        yield v;
        continue;
      }
      {
        ...
        if (k !== -1) {
          ...
          v.value = { kind: "arbitrary", dataType: $ || null, value: y };
        } else {
          let y = f === null || ((_a2 = v.modifier) == null ? void 0 : _a2.kind) === "arbitrary" ? null : `${g}/${f}`;
          v.value = { kind: "named", value: g, fraction: y };
        }
      }
      yield v;
    }
    ...
    }
    {
      ...
      for (let [a, f] of s) switch (r.variants.kind(a)) {
        ...
        case "functional": {
          ...
          if (f === null) return { kind: "functional", root: a, modifier: u, value: null };
          if (f[f.length - 1] === "]") {
            if (f[0] !== "[") continue;
  ...
  var Jo = new W((t) => {
    ...
    return ee(r, (e, { parent: i }) => {
      ...
      if (e.kind === "word" && (e.value === "+" || e.value === "-" || e.value === "*" || e.value === "/")) {
        ...
        if (a === -1) return;
        let f = s[a - 1];
        if ((f == null ? void 0 : f.kind) !== "separator" || f.value !== " ") return;
        let u = s[a + 1];
        if ((u == null ? void 0 : u.kind) !== "separator" || u.value !== " ") return;
        o.add(f), o.add(u);
  ...
  var ai = /^(?:element|image|cross-fade|image-set)\(/, si = /^(repeating-)?(conic|linear|radial)-gradient\(/;
  function ui(t) {
    let r = 0;
    for (let o of U(t, ",")) if (!o.startsWith("var(")) {
      if (Nr(o)) {
        r += 1;
        continue;
      }
  ...
  var de = /[+-]?\d*\.?\d+(?:[eE][+-]?\d+)?/, mi = new RegExp(`^${de.source}$`);
  function Sr(t) {
  ...
  var vi = ["cm", "mm", "Q", "in", "pc", "pt", "px", "em", "ex", "ch", "rem", "lh", "rlh", "vw", "vh", "vmin", "vmax", "vb", "vi", "svw", "svh", "lvw", "lvh", "dvw", "dvh", "cqw", "cqh", "cqi", "cqb", "cqmin", "cqmax"], wi = new RegExp(`^${de.source}(${vi.join("|")})$`);
  function ot(t) {
  ...
  function yi(t) {
    ...
    for (let o of U(t, ",")) {
      ...
      let e = U(o, " ");
      if (e.length !== 1 && e.length !== 2) return false;
  ...
  var xi = ["deg", "rad", "grad", "turn"], Ai = new RegExp(`^${de.source}(${xi.join("|")})$`);
  function Ci(t) {
    return Ai.test(t);
  }
  ...
  var $i = /* @__PURE__ */ new Set(["inset", "inherit", "initial", "revert", "unset"]), Vr = /^-?(\d+|\.\d+)(.*?)$/g;
  function ze(t, r) {
    return U(t, ",").map((e) => {
      e = e.trim();
      let i = U(e, " ").filter((c) => c.trim() !== ""), s = null, a = null, f = null;
  ...
  var Vi = /^-?[a-z][a-zA-Z0-9/%._-]*$/, Ei = /^-?[a-z][a-zA-Z0-9/%._-]*-\*$/, lt = ["0", "0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4", "5", "6", "7", "8", "9", "10", "11", "12", "14", "16", "20", "24", "28", "32", "36", "40", "44", "48", "52", "56", "60", "64", "72", "80", "96"], _t = class {
    constructor() {
  ...
  function Pr(t) {
    ...
    function o(n, d) {
      ...
      r.suggest(n, () => {
        ...
        for (let C of d()) {
          ...
          let O = [...C.values ?? [], ...h(C.valueThemeKeys ?? [])], S = [...C.modifiers ?? [], ...h(C.modifierThemeKeys ?? [])];
          C.supportsFractions && O.push(...A), C.hasDefaultValue && O.unshift(null), w.push({ supportsNegative: C.supportsNegative, values: O, modifiers: S });
        }
        return w;
      });
    }
    ...
    function i(n, d) {
        ...
        return (w) => {
          ...
          if (w.value) if (w.value.kind === "arbitrary") {
            ...
            if (C === null && A && d.handleNegativeBareValue) {
              if (C = d.handleNegativeBareValue(w.value), !(C == null ? void 0 : C.includes("/")) && w.modifier) return;
              if (C !== null) return d.handle(C, null);
            }
            if (C === null && d.handleBareValue && (C = d.handleBareValue(w.value), !(C == null ? void 0 : C.includes("/")) && w.modifier)) return;
          }
          else {
            if (w.modifier) return;
      ...
      d.supportsNegative && r.functional(`-${n}`, h({ negative: true })), r.functional(n, h({ negative: false })), o(n, () => [{ supportsNegative: d.supportsNegative, valueThemeKeys: d.themeKeys ?? [], hasDefaultValue: d.defaultValue !== void 0 && d.defaultValue !== null, supportsFractions: d.supportsFractions }]);
    }
    function s(n, d) {
      r.functional(n, (h) => {
        if (!h.value) return;
      ...
      }), o(n, () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: d.themeKeys, modifiers: Array.from({ length: 21 }, (h, A) => `${A * 5}`) }]);
    }
    function a(n, d, h, { supportsNegative: A = false, supportsFractions: w = false } = {}) {
      A && r.static(`-${n}-px`, () => h("-1px")), r.static(`${n}-px`, () => h("1px")), i(n, { themeKeys: d, supportsFractions: w, supportsNegative: A, defaultValue: null, handleBareValue: ({ value: C }) => {
        let O = t.resolve(null, ["--spacing"]);
        return !O || !xe(C) ? null : `calc(${O} * ${C})`;
      }, handleNegativeBareValue: ({ value: C }) => {
        let O = t.resolve(null, ["--spacing"]);
        return !O || !xe(C) ? null : `calc(${O} * -${C})`;
      }, handle: h }), o(n, () => [{ values: t.get(["--spacing"]) ? lt : [], supportsNegative: A, supportsFractions: w, valueThemeKeys: d }]);
    }
    ...
    for (let [n, d] of [["inset", "inset"], ["inset-x", "inset-inline"], ["inset-y", "inset-block"], ["start", "inset-inline-start"], ["end", "inset-inline-end"], ["top", "top"], ["right", "right"], ["bottom", "bottom"], ["left", "left"]]) e(`${n}-auto`, [[d, "auto"]]), e(`${n}-full`, [[d, "100%"]]), e(`-${n}-full`, [[d, "-100%"]]), a(n, ["--inset", "--spacing"], (h) => [l(d, h)], { supportsNegative: true, supportsFractions: true });
    e("isolate", [["isolation", "isolate"]]), e("isolation-auto", [["isolation", "auto"]]), e("z-auto", [["z-index", "auto"]]), i("z", { supportsNegative: true, handleBareValue: ({ value: n }) => T(n) ? n : null, themeKeys: ["--z-index"], handle: (n) => [l("z-index", n)] }), o("z", () => [{ supportsNegative: true, values: ["0", "10", "20", "30", "40", "50"], valueThemeKeys: ["--z-index"] }]), e("order-first", [["order", "-9999"]]), e("order-last", [["order", "9999"]]), i("order", { supportsNegative: true, handleBareValue: ({ value: n }) => T(n) ? n : null, themeKeys: ["--order"], handle: (n) => [l("order", n)] }), o("order", () => [{ supportsNegative: true, values: Array.from({ length: 12 }, (n, d) => `${d + 1}`), valueThemeKeys: ["--order"] }]), e("col-auto", [["grid-column", "auto"]]), i("col", { supportsNegative: true, handleBareValue: ({ value: n }) => T(n) ? n : null, themeKeys: ["--grid-column"], handle: (n) => [l("grid-column", n)] }), e("col-span-full", [["grid-column", "1 / -1"]]), i("col-span", { handleBareValue: ({ value: n }) => T(n) ? n : null, handle: (n) => [l("grid-column", `span ${n} / span ${n}`)] }), e("col-start-auto", [["grid-column-start", "auto"]]), i("col-start", { supportsNegative: true, handleBareValue: ({ value: n }) => T(n) ? n : null, themeKeys: ["--grid-column-start"], handle: (n) => [l("grid-column-start", n)] }), e("col-end-auto", [["grid-column-end", "auto"]]), i("col-end", { supportsNegative: true, handleBareValue: ({ value: n }) => T(n) ? n : null, themeKeys: ["--grid-column-end"], handle: (n) => [l("grid-column-end", n)] }), o("col-span", () => [{ values: Array.from({ length: 12 }, (n, d) => `${d + 1}`), valueThemeKeys: [] }]), o("col-start", () => [{ supportsNegative: true, values: Array.from({ length: 13 }, (n, d) => `${d + 1}`), valueThemeKeys: ["--grid-column-start"] }]), o("col-end", () => [{ supportsNegative: true, values: Array.from({ length: 13 }, (n, d) => `${d + 1}`), valueThemeKeys: ["--grid-column-end"] }]), e("row-auto", [["grid-row", "auto"]]), i("row", { supportsNegative: true, handleBareValue: ({ value: n }) => T(n) ? n : null, themeKeys: ["--grid-row"], handle: (n) => [l("grid-row", n)] }), e("row-span-full", [["grid-row", "1 / -1"]]), i("row-span", { themeKeys: [], handleBareValue: ({ value: n }) => T(n) ? n : null, handle: (n) => [l("grid-row", `span ${n} / span ${n}`)] }), e("row-start-auto", [["grid-row-start", "auto"]]), i("row-start", { supportsNegative: true, handleBareValue: ({ value: n }) => T(n) ? n : null, themeKeys: ["--grid-row-start"], handle: (n) => [l("grid-row-start", n)] }), e("row-end-auto", [["grid-row-end", "auto"]]), i("row-end", { supportsNegative: true, handleBareValue: ({ value: n }) => T(n) ? n : null, themeKeys: ["--grid-row-end"], handle: (n) => [l("grid-row-end", n)] }), o("row-span", () => [{ values: Array.from({ length: 12 }, (n, d) => `${d + 1}`), valueThemeKeys: [] }]), o("row-start", () => [{ supportsNegative: true, values: Array.from({ length: 13 }, (n, d) => `${d + 1}`), valueThemeKeys: ["--grid-row-start"] }]), o("row-end", () => [{ supportsNegative: true, values: Array.from({ length: 13 }, (n, d) => `${d + 1}`), valueThemeKeys: ["--grid-row-end"] }]), e("float-start", [["float", "inline-start"]]), e("float-end", [["float", "inline-end"]]), e("float-right", [["float", "right"]]), e("float-left", [["float", "left"]]), e("float-none", [["float", "none"]]), e("clear-start", [["clear", "inline-start"]]), e("clear-end", [["clear", "inline-end"]]), e("clear-right", [["clear", "right"]]), e("clear-left", [["clear", "left"]]), e("clear-both", [["clear", "both"]]), e("clear-none", [["clear", "none"]]);
    for (let [n, d] of [["m", "margin"], ["mx", "margin-inline"], ["my", "margin-block"], ["ms", "margin-inline-start"], ["me", "margin-inline-end"], ["mt", "margin-top"], ["mr", "margin-right"], ["mb", "margin-bottom"], ["ml", "margin-left"]]) e(`${n}-auto`, [[d, "auto"]]), a(n, ["--margin", "--spacing"], (h) => [l(d, h)], { supportsNegative: true });
    ...
    for (let [n, d] of [["full", "100%"], ["svw", "100svw"], ["lvw", "100lvw"], ["dvw", "100dvw"], ["svh", "100svh"], ["lvh", "100lvh"], ["dvh", "100dvh"], ["min", "min-content"], ["max", "max-content"], ["fit", "fit-content"]]) e(`size-${n}`, [["--tw-sort", "size"], ["width", d], ["height", d]]), e(`w-${n}`, [["width", d]]), e(`h-${n}`, [["height", d]]), e(`min-w-${n}`, [["min-width", d]]), e(`min-h-${n}`, [["min-height", d]]), e(`max-w-${n}`, [["max-width", d]]), e(`max-h-${n}`, [["max-height", d]]);
    ...
    for (let [n, d, h] of [["w", ["--width", "--spacing", "--container"], "width"], ["min-w", ["--min-width", "--spacing", "--container"], "min-width"], ["max-w", ["--max-width", "--spacing", "--container"], "max-width"], ["h", ["--height", "--spacing"], "height"], ["min-h", ["--min-height", "--height", "--spacing"], "min-height"], ["max-h", ["--max-height", "--height", "--spacing"], "max-height"]]) a(n, d, (A) => [l(h, A)], { supportsFractions: true });
    r.static("container", () => {
    ...
    }), o("flex", () => [{ supportsFractions: true }]), i("shrink", { defaultValue: "1", handleBareValue: ({ value: n }) => T(n) ? n : null, handle: (n) => [l("flex-shrink", n)] }), i("grow", { defaultValue: "1", handleBareValue: ({ value: n }) => T(n) ? n : null, handle: (n) => [l("flex-grow", n)] }), o("shrink", () => [{ values: ["0"], valueThemeKeys: [], hasDefaultValue: true }]), o("grow", () => [{ values: ["0"], valueThemeKeys: [], hasDefaultValue: true }]), e("basis-auto", [["flex-basis", "auto"]]), e("basis-full", [["flex-basis", "100%"]]), a("basis", ["--flex-basis", "--spacing", "--container"], (n) => [l("flex-basis", n)], { supportsFractions: true }), e("table-auto", [["table-layout", "auto"]]), e("table-fixed", [["table-layout", "fixed"]]), e("caption-top", [["caption-side", "top"]]), e("caption-bottom", [["caption-side", "bottom"]]), e("border-collapse", [["border-collapse", "collapse"]]), e("border-separate", [["border-collapse", "separate"]]);
    ...
    for (let n of ["x", "y"]) e(`-translate-${n}-full`, [u, [`--tw-translate-${n}`, "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), e(`translate-${n}-full`, [u, [`--tw-translate-${n}`, "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), a(`translate-${n}`, ["--translate", "--spacing"], (d) => [u(), l(`--tw-translate-${n}`, d), l("translate", "var(--tw-translate-x) var(--tw-translate-y)")], { supportsNegative: true, supportsFractions: true });
    ...
    r.functional("-scale", p({ negative: true })), r.functional("scale", p({ negative: false })), o("scale", () => [{ supportsNegative: true, values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"], valueThemeKeys: ["--scale"] }]);
    for (let n of ["x", "y", "z"]) i(`scale-${n}`, { supportsNegative: true, themeKeys: ["--scale"], handleBareValue: ({ value: d }) => T(d) ? `${d}%` : null, handle: (d) => [c(), l(`--tw-scale-${n}`, d), l("scale", `var(--tw-scale-x) var(--tw-scale-y)${n === "z" ? " var(--tw-scale-z)" : ""}`)] }), o(`scale-${n}`, () => [{ supportsNegative: true, values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"], valueThemeKeys: ["--scale"] }]);
    ...
    r.functional("-rotate", m({ negative: true })), r.functional("rotate", m({ negative: false })), o("rotate", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"], valueThemeKeys: ["--rotate"] }]);
    {
      let n = ["var(--tw-rotate-x,)", "var(--tw-rotate-y,)", "var(--tw-rotate-z,)", "var(--tw-skew-x,)", "var(--tw-skew-y,)"].join(" "), d = () => I([N("--tw-rotate-x"), N("--tw-rotate-y"), N("--tw-rotate-z"), N("--tw-skew-x"), N("--tw-skew-y")]);
      for (let h of ["x", "y", "z"]) i(`rotate-${h}`, { supportsNegative: true, themeKeys: ["--rotate"], handleBareValue: ({ value: A }) => T(A) ? `${A}deg` : null, handle: (A) => [d(), l(`--tw-rotate-${h}`, `rotate${h.toUpperCase()}(${A})`), l("transform", n)] }), o(`rotate-${h}`, () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"], valueThemeKeys: ["--rotate"] }]);
      i("skew", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: h }) => T(h) ? `${h}deg` : null, handle: (h) => [d(), l("--tw-skew-x", `skewX(${h})`), l("--tw-skew-y", `skewY(${h})`), l("transform", n)] }), i("skew-x", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: h }) => T(h) ? `${h}deg` : null, handle: (h) => [d(), l("--tw-skew-x", `skewX(${h})`), l("transform", n)] }), i("skew-y", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: h }) => T(h) ? `${h}deg` : null, handle: (h) => [d(), l("--tw-skew-y", `skewY(${h})`), l("transform", n)] }), o("skew", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), o("skew-x", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), o("skew-y", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), r.functional("transform", (h) => {
    ...
    for (let n of ["x", "left", "right"]) e(`touch-pan-${n}`, [g, ["--tw-pan-x", `pan-${n}`], ["touch-action", "var(--tw-pan-x,) var(--tw-pan-y,) var(--tw-pinch-zoom,)"]]);
    for (let n of ["y", "up", "down"]) e(`touch-pan-${n}`, [g, ["--tw-pan-y", `pan-${n}`], ["touch-action", "var(--tw-pan-x,) var(--tw-pan-y,) var(--tw-pinch-zoom,)"]]);
    e("touch-pinch-zoom", [g, ["--tw-pinch-zoom", "pinch-zoom"], ["touch-action", "var(--tw-pan-x,) var(--tw-pan-y,) var(--tw-pinch-zoom,)"]]);
    ...
    for (let [n, d] of [["rounded", ["border-radius"]], ["rounded-s", ["border-start-start-radius", "border-end-start-radius"]], ["rounded-e", ["border-start-end-radius", "border-end-end-radius"]], ["rounded-t", ["border-top-left-radius", "border-top-right-radius"]], ["rounded-r", ["border-top-right-radius", "border-bottom-right-radius"]], ["rounded-b", ["border-bottom-right-radius", "border-bottom-left-radius"]], ["rounded-l", ["border-top-left-radius", "border-bottom-left-radius"]], ["rounded-ss", ["border-start-start-radius"]], ["rounded-se", ["border-start-end-radius"]], ["rounded-ee", ["border-end-end-radius"]], ["rounded-es", ["border-end-start-radius"]], ["rounded-tl", ["border-top-left-radius"]], ["rounded-tr", ["border-top-right-radius"]], ["rounded-br", ["border-bottom-right-radius"]], ["rounded-bl", ["border-bottom-left-radius"]]]) e(`${n}-none`, d.map((h) => [h, "0"])), e(`${n}-full`, d.map((h) => [h, "calc(infinity * 1px)"])), i(n, { themeKeys: ["--radius"], handle: (h) => d.map((A) => l(A, h)) });
    ...
    } }), e("bg-repeat", [["background-repeat", "repeat"]]), e("bg-no-repeat", [["background-repeat", "no-repeat"]]), e("bg-repeat-x", [["background-repeat", "repeat-x"]]), e("bg-repeat-y", [["background-repeat", "repeat-y"]]), e("bg-repeat-round", [["background-repeat", "round"]]), e("bg-repeat-space", [["background-repeat", "space"]]), e("bg-none", [["background-image", "none"]]);
    {
      let h = function(C) {
        let O = "in oklab";
        if ((C == null ? void 0 : C.kind) === "named") switch (C.value) {
          case "longer":
          case "shorter":
          case "increasing":
          case "decreasing":
        ...
        else (C == null ? void 0 : C.kind) === "arbitrary" && (O = C.value);
        return O;
        ...
        return (O) => {
          var _a2;
          if (((_a2 = O.value) == null ? void 0 : _a2.kind) === "arbitrary") {
            if (O.modifier) return;
            let z = O.value.value;
      ...
      var H = h, L = A, B = w;
      let n = ["oklab", "oklch", "srgb", "hsl", "longer", "shorter", "increasing", "decreasing"], d = /* @__PURE__ */ new Map([["to-t", "to top"], ["to-tr", "to top right"], ["to-r", "to right"], ["to-br", "to bottom right"], ["to-b", "to bottom"], ["to-bl", "to bottom left"], ["to-l", "to left"], ["to-tl", "to top left"]]);
      r.functional("-bg-linear", A({ negative: true })), r.functional("bg-linear", A({ negative: false })), o("bg-linear", () => [{ values: [...d.keys()], modifiers: n }, { values: ["0", "30", "60", "90", "120", "150", "180", "210", "240", "270", "300", "330"], supportsNegative: true, modifiers: n }]), r.functional("-bg-conic", w({ negative: true })), r.functional("bg-conic", w({ negative: false })), o("bg-conic", () => [{ hasDefaultValue: true, modifiers: n }, { values: ["0", "30", "60", "90", "120", "150", "180", "210", "240", "270", "300", "330"], supportsNegative: true, modifiers: n }]), r.functional("bg-radial", (C) => {
        if (!C.value) {
          let O = h(C.modifier);
    ...
    }), o("bg", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--background-color", "--color"], modifiers: Array.from({ length: 21 }, (n, d) => `${d * 5}`) }, { values: [], valueThemeKeys: ["--background-image"] }]);
    ...
    }), o("fill", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--fill", "--color"], modifiers: Array.from({ length: 21 }, (n, d) => `${d * 5}`) }]), e("stroke-none", [["stroke", "none"]]), r.functional("stroke", (n) => {
      if (n.value) {
        if (n.value.kind === "arbitrary") {
          let d = n.value.value;
    ...
    }), o("stroke", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--stroke", "--color"], modifiers: Array.from({ length: 21 }, (n, d) => `${d * 5}`) }, { values: ["0", "1", "2", "3"], valueThemeKeys: ["--stroke-width"] }]), e("object-contain", [["object-fit", "contain"]]), e("object-cover", [["object-fit", "cover"]]), e("object-fill", [["object-fit", "fill"]]), e("object-none", [["object-fit", "none"]]), e("object-scale-down", [["object-fit", "scale-down"]]), e("object-top", [["object-position", "top"]]), e("object-top-left", [["object-position", "left top"]]), e("object-top-right", [["object-position", "right top"]]), e("object-bottom", [["object-position", "bottom"]]), e("object-bottom-left", [["object-position", "left bottom"]]), e("object-bottom-right", [["object-position", "right bottom"]]), e("object-left", [["object-position", "left"]]), e("object-right", [["object-position", "right"]]), e("object-center", [["object-position", "center"]]), i("object", { themeKeys: ["--object-position"], handle: (n) => [l("object-position", n)] });
    for (let [n, d] of [["p", "padding"], ["px", "padding-inline"], ["py", "padding-block"], ["ps", "padding-inline-start"], ["pe", "padding-inline-end"], ["pt", "padding-top"], ["pr", "padding-right"], ["pb", "padding-bottom"], ["pl", "padding-left"]]) a(n, ["--padding", "--spacing"], (h) => [l(d, h)]);
    ...
    }), o("decoration", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--text-decoration-color", "--color"], modifiers: Array.from({ length: 21 }, (n, d) => `${d * 5}`) }, { values: ["0", "1", "2"], valueThemeKeys: ["--text-decoration-thickness"] }]), e("animate-none", [["animation", "none"]]), i("animate", { themeKeys: ["--animate"], handle: (n) => [l("animation", n)] });
    {
      ...
      r.functional("filter", (w) => {
      ...
      }), i("blur", { themeKeys: ["--blur"], handle: (w) => [h(), l("--tw-blur", `blur(${w})`), l("filter", n)] }), e("blur-none", [h, ["--tw-blur", " "], ["filter", n]]), i("backdrop-blur", { themeKeys: ["--backdrop-blur", "--blur"], handle: (w) => [A(), l("--tw-backdrop-blur", `blur(${w})`), l("-webkit-backdrop-filter", d), l("backdrop-filter", d)] }), e("backdrop-blur-none", [A, ["--tw-backdrop-blur", " "], ["-webkit-backdrop-filter", d], ["backdrop-filter", d]]), i("brightness", { themeKeys: ["--brightness"], handleBareValue: ({ value: w }) => T(w) ? `${w}%` : null, handle: (w) => [h(), l("--tw-brightness", `brightness(${w})`), l("filter", n)] }), i("backdrop-brightness", { themeKeys: ["--backdrop-brightness", "--brightness"], handleBareValue: ({ value: w }) => T(w) ? `${w}%` : null, handle: (w) => [A(), l("--tw-backdrop-brightness", `brightness(${w})`), l("-webkit-backdrop-filter", d), l("backdrop-filter", d)] }), o("brightness", () => [{ values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"], valueThemeKeys: ["--brightness"] }]), o("backdrop-brightness", () => [{ values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"], valueThemeKeys: ["--backdrop-brightness", "--brightness"] }]), i("contrast", { themeKeys: ["--contrast"], handleBareValue: ({ value: w }) => T(w) ? `${w}%` : null, handle: (w) => [h(), l("--tw-contrast", `contrast(${w})`), l("filter", n)] }), i("backdrop-contrast", { themeKeys: ["--backdrop-contrast", "--contrast"], handleBareValue: ({ value: w }) => T(w) ? `${w}%` : null, handle: (w) => [A(), l("--tw-backdrop-contrast", `contrast(${w})`), l("-webkit-backdrop-filter", d), l("backdrop-filter", d)] }), o("contrast", () => [{ values: ["0", "50", "75", "100", "125", "150", "200"], valueThemeKeys: ["--contrast"] }]), o("backdrop-contrast", () => [{ values: ["0", "50", "75", "100", "125", "150", "200"], valueThemeKeys: ["--backdrop-contrast", "--contrast"] }]), i("grayscale", { themeKeys: ["--grayscale"], handleBareValue: ({ value: w }) => T(w) ? `${w}%` : null, defaultValue: "100%", handle: (w) => [h(), l("--tw-grayscale", `grayscale(${w})`), l("filter", n)] }), i("backdrop-grayscale", { themeKeys: ["--backdrop-grayscale", "--grayscale"], handleBareValue: ({ value: w }) => T(w) ? `${w}%` : null, defaultValue: "100%", handle: (w) => [A(), l("--tw-backdrop-grayscale", `grayscale(${w})`), l("-webkit-backdrop-filter", d), l("backdrop-filter", d)] }), o("grayscale", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--grayscale"], hasDefaultValue: true }]), o("backdrop-grayscale", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--backdrop-grayscale", "--grayscale"], hasDefaultValue: true }]), i("hue-rotate", { supportsNegative: true, themeKeys: ["--hue-rotate"], handleBareValue: ({ value: w }) => T(w) ? `${w}deg` : null, handle: (w) => [h(), l("--tw-hue-rotate", `hue-rotate(${w})`), l("filter", n)] }), i("backdrop-hue-rotate", { supportsNegative: true, themeKeys: ["--backdrop-hue-rotate", "--hue-rotate"], handleBareValue: ({ value: w }) => T(w) ? `${w}deg` : null, handle: (w) => [A(), l("--tw-backdrop-hue-rotate", `hue-rotate(${w})`), l("-webkit-backdrop-filter", d), l("backdrop-filter", d)] }), o("hue-rotate", () => [{ values: ["0", "15", "30", "60", "90", "180"], valueThemeKeys: ["--hue-rotate"] }]), o("backdrop-hue-rotate", () => [{ values: ["0", "15", "30", "60", "90", "180"], valueThemeKeys: ["--backdrop-hue-rotate", "--hue-rotate"] }]), i("invert", { themeKeys: ["--invert"], handleBareValue: ({ value: w }) => T(w) ? `${w}%` : null, defaultValue: "100%", handle: (w) => [h(), l("--tw-invert", `invert(${w})`), l("filter", n)] }), i("backdrop-invert", { themeKeys: ["--backdrop-invert", "--invert"], handleBareValue: ({ value: w }) => T(w) ? `${w}%` : null, defaultValue: "100%", handle: (w) => [A(), l("--tw-backdrop-invert", `invert(${w})`), l("-webkit-backdrop-filter", d), l("backdrop-filter", d)] }), o("invert", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--invert"], hasDefaultValue: true }]), o("backdrop-invert", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--backdrop-invert", "--invert"], hasDefaultValue: true }]), i("saturate", { themeKeys: ["--saturate"], handleBareValue: ({ value: w }) => T(w) ? `${w}%` : null, handle: (w) => [h(), l("--tw-saturate", `saturate(${w})`), l("filter", n)] }), i("backdrop-saturate", { themeKeys: ["--backdrop-saturate", "--saturate"], handleBareValue: ({ value: w }) => T(w) ? `${w}%` : null, handle: (w) => [A(), l("--tw-backdrop-saturate", `saturate(${w})`), l("-webkit-backdrop-filter", d), l("backdrop-filter", d)] }), o("saturate", () => [{ values: ["0", "50", "100", "150", "200"], valueThemeKeys: ["--saturate"] }]), o("backdrop-saturate", () => [{ values: ["0", "50", "100", "150", "200"], valueThemeKeys: ["--backdrop-saturate", "--saturate"] }]), i("sepia", { themeKeys: ["--sepia"], handleBareValue: ({ value: w }) => T(w) ? `${w}%` : null, defaultValue: "100%", handle: (w) => [h(), l("--tw-sepia", `sepia(${w})`), l("filter", n)] }), i("backdrop-sepia", { themeKeys: ["--backdrop-sepia", "--sepia"], handleBareValue: ({ value: w }) => T(w) ? `${w}%` : null, defaultValue: "100%", handle: (w) => [A(), l("--tw-backdrop-sepia", `sepia(${w})`), l("-webkit-backdrop-filter", d), l("backdrop-filter", d)] }), o("sepia", () => [{ values: ["0", "50", "100"], valueThemeKeys: ["--sepia"], hasDefaultValue: true }]), o("backdrop-sepia", () => [{ values: ["0", "50", "100"], valueThemeKeys: ["--backdrop-sepia", "--sepia"], hasDefaultValue: true }]), e("drop-shadow-none", [h, ["--tw-drop-shadow", " "], ["filter", n]]), r.functional("drop-shadow", (w) => {
        let C;
        if (w.modifier && (w.modifier.kind === "arbitrary" ? C = w.modifier.value : T(w.modifier.value) && (C = `${w.modifier.value}%`)), !w.value) {
          let O = t.get(["--drop-shadow"]), S = t.resolve(null, ["--drop-shadow"]);
        ...
        {
          let O = t.get([`--drop-shadow-${w.value.value}`]), S = t.resolve(w.value.value, ["--drop-shadow"]);
      ...
      }), o("drop-shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--drop-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (w, C) => `${C * 5}`) }, { valueThemeKeys: ["--drop-shadow"] }]), i("backdrop-opacity", { themeKeys: ["--backdrop-opacity", "--opacity"], handleBareValue: ({ value: w }) => it(w) ? `${w}%` : null, handle: (w) => [A(), l("--tw-backdrop-opacity", `opacity(${w})`), l("-webkit-backdrop-filter", d), l("backdrop-filter", d)] }), o("backdrop-opacity", () => [{ values: Array.from({ length: 21 }, (w, C) => `${C * 5}`), valueThemeKeys: ["--backdrop-opacity", "--opacity"] }]);
    }
    {
      let n = `var(--tw-ease, ${t.resolve(null, ["--default-transition-timing-function"]) ?? "ease"})`, d = `var(--tw-duration, ${t.resolve(null, ["--default-transition-duration"]) ?? "0s"})`;
      e("transition-none", [["transition-property", "none"]]), e("transition-all", [["transition-property", "all"], ["transition-timing-function", n], ["transition-duration", d]]), e("transition-colors", [["transition-property", "color, background-color, border-color, outline-color, text-decoration-color, fill, stroke, --tw-gradient-from, --tw-gradient-via, --tw-gradient-to"], ["transition-timing-function", n], ["transition-duration", d]]), e("transition-opacity", [["transition-property", "opacity"], ["transition-timing-function", n], ["transition-duration", d]]), e("transition-shadow", [["transition-property", "box-shadow"], ["transition-timing-function", n], ["transition-duration", d]]), e("transition-transform", [["transition-property", "transform, translate, scale, rotate"], ["transition-timing-function", n], ["transition-duration", d]]), i("transition", { defaultValue: "color, background-color, border-color, outline-color, text-decoration-color, fill, stroke, --tw-gradient-from, --tw-gradient-via, --tw-gradient-to, opacity, box-shadow, transform, translate, scale, rotate, filter, -webkit-backdrop-filter, backdrop-filter, display, visibility, content-visibility, overlay, pointer-events", themeKeys: ["--transition-property"], handle: (h) => [l("transition-property", h), l("transition-timing-function", n), l("transition-duration", d)] }), e("transition-discrete", [["transition-behavior", "allow-discrete"]]), e("transition-normal", [["transition-behavior", "normal"]]), i("delay", { handleBareValue: ({ value: h }) => T(h) ? `${h}ms` : null, themeKeys: ["--transition-delay"], handle: (h) => [l("transition-delay", h)] });
      {
    ...
    {
      let n = () => I([N("--tw-ease")]);
      e("ease-initial", [n, ["--tw-ease", "initial"]]), e("ease-linear", [n, ["--tw-ease", "linear"], ["transition-timing-function", "linear"]]), i("ease", { themeKeys: ["--ease"], handle: (d) => [n(), l("--tw-ease", d), l("transition-timing-function", d)] });
    }
    e("will-change-auto", [["will-change", "auto"]]), e("will-change-scroll", [["will-change", "scroll-position"]]), e("will-change-contents", [["will-change", "contents"]]), e("will-change-transform", [["will-change", "transform"]]), i("will-change", { themeKeys: [], handle: (n) => [l("will-change", n)] }), e("content-none", [["--tw-content", "none"], ["content", "none"]]), i("content", { themeKeys: [], handle: (n) => [I([N("--tw-content", '""')]), l("--tw-content", n), l("content", "var(--tw-content)")] });
    {
      let n = "var(--tw-contain-size,) var(--tw-contain-layout,) var(--tw-contain-paint,) var(--tw-contain-style,)", d = () => I([N("--tw-contain-size"), N("--tw-contain-layout"), N("--tw-contain-paint"), N("--tw-contain-style")]);
      e("contain-none", [["contain", "none"]]), e("contain-content", [["contain", "content"]]), e("contain-strict", [["contain", "strict"]]), e("contain-size", [d, ["--tw-contain-size", "size"], ["contain", n]]), e("contain-inline-size", [d, ["--tw-contain-size", "inline-size"], ["contain", n]]), e("contain-layout", [d, ["--tw-contain-layout", "layout"], ["contain", n]]), e("contain-paint", [d, ["--tw-contain-paint", "paint"], ["contain", n]]), e("contain-style", [d, ["--tw-contain-style", "style"], ["contain", n]]), i("contain", { themeKeys: [], handle: (h) => [l("contain", h)] });
    }
    e("forced-color-adjust-none", [["forced-color-adjust", "none"]]), e("forced-color-adjust-auto", [["forced-color-adjust", "auto"]]), e("leading-none", [() => I([N("--tw-leading")]), ["--tw-leading", "1"], ["line-height", "1"]]), a("leading", ["--leading", "--spacing"], (n) => [I([N("--tw-leading")]), l("--tw-leading", n), l("line-height", n)]), i("tracking", { supportsNegative: true, themeKeys: ["--tracking"], handle: (n) => [I([N("--tw-tracking")]), l("--tw-tracking", n), l("letter-spacing", n)] }), e("antialiased", [["-webkit-font-smoothing", "antialiased"], ["-moz-osx-font-smoothing", "grayscale"]]), e("subpixel-antialiased", [["-webkit-font-smoothing", "auto"], ["-moz-osx-font-smoothing", "auto"]]);
    {
      let n = "var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,)", d = () => I([N("--tw-ordinal"), N("--tw-slashed-zero"), N("--tw-numeric-figure"), N("--tw-numeric-spacing"), N("--tw-numeric-fraction")]);
      e("normal-nums", [["font-variant-numeric", "normal"]]), e("ordinal", [d, ["--tw-ordinal", "ordinal"], ["font-variant-numeric", n]]), e("slashed-zero", [d, ["--tw-slashed-zero", "slashed-zero"], ["font-variant-numeric", n]]), e("lining-nums", [d, ["--tw-numeric-figure", "lining-nums"], ["font-variant-numeric", n]]), e("oldstyle-nums", [d, ["--tw-numeric-figure", "oldstyle-nums"], ["font-variant-numeric", n]]), e("proportional-nums", [d, ["--tw-numeric-spacing", "proportional-nums"], ["font-variant-numeric", n]]), e("tabular-nums", [d, ["--tw-numeric-spacing", "tabular-nums"], ["font-variant-numeric", n]]), e("diagonal-fractions", [d, ["--tw-numeric-fraction", "diagonal-fractions"], ["font-variant-numeric", n]]), e("stacked-fractions", [d, ["--tw-numeric-fraction", "stacked-fractions"], ["font-variant-numeric", n]]);
    }
    {
      let n = () => I([N("--tw-outline-style", "solid")]);
      r.static("outline-hidden", () => [l("--tw-outline-style", "none"), l("outline-style", "none"), F("@media", "(forced-colors: active)", [l("outline", "2px solid transparent"), l("outline-offset", "2px")])]), e("outline-none", [["--tw-outline-style", "none"], ["outline-style", "none"]]), e("outline-solid", [["--tw-outline-style", "solid"], ["outline-style", "solid"]]), e("outline-dashed", [["--tw-outline-style", "dashed"], ["outline-style", "dashed"]]), e("outline-dotted", [["--tw-outline-style", "dotted"], ["outline-style", "dotted"]]), e("outline-double", [["--tw-outline-style", "double"], ["outline-style", "double"]]), r.functional("outline", (d) => {
        if (d.value === null) {
      ...
      }), o("outline", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--outline-color", "--color"], modifiers: Array.from({ length: 21 }, (d, h) => `${h * 5}`), hasDefaultValue: true }, { values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--outline-width"] }]), i("outline-offset", { supportsNegative: true, themeKeys: ["--outline-offset"], handleBareValue: ({ value: d }) => T(d) ? `${d}px` : null, handle: (d) => [l("outline-offset", d)] }), o("outline-offset", () => [{ supportsNegative: true, values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--outline-offset"] }]);
    }
    i("opacity", { themeKeys: ["--opacity"], handleBareValue: ({ value: n }) => it(n) ? `${n}%` : null, handle: (n) => [l("opacity", n)] }), o("opacity", () => [{ values: Array.from({ length: 21 }, (n, d) => `${d * 5}`), valueThemeKeys: ["--opacity"] }]), e("underline-offset-auto", [["text-underline-offset", "auto"]]), i("underline-offset", { supportsNegative: true, themeKeys: ["--text-underline-offset"], handleBareValue: ({ value: n }) => T(n) ? `${n}px` : null, handle: (n) => [l("text-underline-offset", n)] }), o("underline-offset", () => [{ supportsNegative: true, values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--text-underline-offset"] }]), r.functional("text", (n) => {
      if (n.value) {
        if (n.value.kind === "arbitrary") {
          let d = n.value.value;
    ...
    }), o("text", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--text-color", "--color"], modifiers: Array.from({ length: 21 }, (n, d) => `${d * 5}`) }, { values: [], valueThemeKeys: ["--text"], modifiers: [], modifierThemeKeys: ["--leading"] }]);
    ...
    }), o("text-shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--text-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (n, d) => `${d * 5}`) }, { values: ["none"] }, { valueThemeKeys: ["--text-shadow"], modifiers: Array.from({ length: 21 }, (n, d) => `${d * 5}`), hasDefaultValue: t.get(["--text-shadow"]) !== null }]);
    {
      let w = function(S) {
      ...
      }), o("shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--box-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (S, E) => `${E * 5}`) }, { values: ["none"] }, { valueThemeKeys: ["--shadow"], modifiers: Array.from({ length: 21 }, (S, E) => `${E * 5}`), hasDefaultValue: t.get(["--shadow"]) !== null }]), e("inset-shadow-initial", [h, ["--tw-inset-shadow-color", "initial"]]), r.functional("inset-shadow", (S) => {
        let E;
        if (S.modifier && (S.modifier.kind === "arbitrary" ? E = S.modifier.value : T(S.modifier.value) && (E = `${S.modifier.value}%`)), !S.value) {
      ...
      }), o("inset-shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--box-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (S, E) => `${E * 5}`) }, { values: ["none"] }, { valueThemeKeys: ["--inset-shadow"], modifiers: Array.from({ length: 21 }, (S, E) => `${E * 5}`), hasDefaultValue: t.get(["--inset-shadow"]) !== null }]), e("ring-inset", [h, ["--tw-ring-inset", "inset"]]);
      ...
      }), o("ring", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--ring-color", "--color"], modifiers: Array.from({ length: 21 }, (S, E) => `${E * 5}`) }, { values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--ring-width"], hasDefaultValue: true }]), r.functional("inset-ring", (S) => {
      ...
      }), o("inset-ring", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--ring-color", "--color"], modifiers: Array.from({ length: 21 }, (S, E) => `${E * 5}`) }, { values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--ring-width"], hasDefaultValue: true }]);
    ...
    return o("ring-offset", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--ring-offset-color", "--color"], modifiers: Array.from({ length: 21 }, (n, d) => `${d * 5}`) }, { values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--ring-offset-width"] }]), r.functional("@container", (n) => {
      let d = null;
      ...
      j(t.nodes, (i) => {
        ...
        ee(s, (a) => {
          ...
          if (a.value === "--spacing" && !(e["--modifier"].usedSpacingNumber && e["--value"].usedSpacingNumber)) return ee(a.nodes, (u) => {
            ...
            let c = u.value;
            for (let p of u.nodes) if (p.kind === "word") {
              if (p.value === "integer") (_a2 = e[c]).usedSpacingInteger || (_a2.usedSpacingInteger = true);
              else if (p.value === "number" && ((_b = e[c]).usedSpacingNumber || (_b.usedSpacingNumber = true), e["--modifier"].usedSpacingNumber && e["--value"].usedSpacingNumber)) return 2;
            }
          }), 0;
...
`);
            let c = u.value, p = structuredClone(a), m = "¶";
            ee(p.nodes, (x, { replaceWith: y }) => {
              x.kind === "word" && x.value === c && y({ kind: "word", value: m });
            });
            let g = "^".repeat(Z([u]).length), v = Z([p]).indexOf(m), k = ["```css", Z([a]), " ".repeat(v) + g, "```"].join(`
`);
            console.warn(k);
          }
        }), i.value = Z(s);
        ...
        if (a === null) return;
        let u = false, c = false, p = false, m = false, g = /* @__PURE__ */ new Map(), v = false;
        if (j([s], (k, { parent: x, replaceWith: y }) => {
          if ((x == null ? void 0 : x.kind) !== "rule" && (x == null ? void 0 : x.kind) !== "at-rule" || k.kind !== "declaration" || !k.value) return;
          let $ = q(k.value);
          (ee($, (V, { replaceWith: R }) => {
            if (V.kind === "function") {
              if (V.value === "--value") {
                u = true;
                let K = Er(a, V, o);
                return K ? (c = true, K.ratio ? v = true : g.set(k, x), R(K.nodes), 1) : (u || (u = false), y([]), 2);
              } else if (V.value === "--modifier") {
                if (f === null) return y([]), 2;
                p = true;
                let K = Er(f, V, o);
                return K ? (m = true, R(K.nodes), 1) : (p || (p = false), y([]), 2);
              }
            }
          }) ?? 0) === 0 && (k.value = Z($));
        }), u && !c || p && !m || v && m || f && !v && !m) return null;
        if (v) for (let [k, x] of g) {
        ...
        let i = [], s = [];
        for (let [a, { literals: f, usedSpacingNumber: u, usedSpacingInteger: c, themeKeys: p }] of [[i, e["--value"]], [s, e["--modifier"]]]) {
          for (let m of f) a.push(m);
          if (u) a.push(...lt);
          else if (c) for (let m of lt) T(m) && a.push(m);
  ...
  function Er(t, r, o) {
    for (let e of r.nodes) {
      if (t.kind === "named" && e.kind === "word" && (e.value[0] === "'" || e.value[0] === '"') && e.value[e.value.length - 1] === e.value[0] && e.value.slice(1, -1) === t.value) return { nodes: q(t.value) };
  ...
  function nt(t, r, o, e, i = "") {
    let s = false, a = U(r, ",").map((f) => ze(f, (u) => o == null ? e(u) : u.startsWith("current") ? e(Q(u, o)) : ((u.startsWith("var(") || o.startsWith("var(")) && (s = true), e(Tr(u, o))))).map((f) => `drop-shadow(${f})`).join(" ");
    return s ? [l(t, i + U(r, ",").map((f) => `drop-shadow(${ze(f, e)})`).join(" ")), G("@supports (color: lab(from red l a b))", [l(t, i + a)])] : [l(t, i + a)];
  }
  var Dt = { "--alpha": Ti, "--spacing": Ri, "--theme": Pi, theme: Oi };
  function Ti(t, r, o, ...e) {
  ...
  function Ur(t, r, o) {
    ...
    return ee(e, (i, { replaceWith: s }) => {
      if (i.kind === "function" && i.value in Dt) {
        let a = U(Z(i.nodes).trim(), ",").map((u) => u.trim()), f = Dt[i.value](o, r, ...a);
        return s(q(f));
      }
    }), Z(e);
  }
  ...
  function Dr(t) {
    ...
    for (let i of t.utilities.keys("functional")) {
      ...
      for (let a of s) for (let f of a.values) {
        let u = f !== null && Di.test(f), c = f === null ? i : `${i}-${f}`, p = r.get(c);
        if (p.utility = i, p.fraction || (p.fraction = u), p.modifiers.push(...a.modifiers), a.supportsNegative) {
          let m = r.get(`-${c}`);
          m.utility = `-${i}`, m.fraction || (m.fraction = u), m.modifiers.push(...a.modifiers);
        }
      }
    }
    if (r.size === 0) return [];
  ...
  function zi(t) {
    let r = [], o = null, e = /* @__PURE__ */ new Map(), i = new W(() => []);
    for (let a of t) {
    ...
    let s = [];
    for (let a of r) for (let f of a.items) s.push([f.name, { modifiers: f.modifiers }]);
    return s;
  }
  function zr(t) {
    let r = [];
    for (let [e, i] of t.variants.entries()) {
      let f = function({ value: u, modifier: c } = {}) {
        ...
        let v = [];
        return Xe(g.nodes, (k, { path: x }) => {
          if (k.kind !== "rule" && k.kind !== "at-rule" || k.nodes.length > 0) return;
          x.sort((b, V) => {
            let R = b.kind === "at-rule", K = V.kind === "at-rule";
  ...
  function Kr(t, r) {
    ...
    for (let a of o) {
      let f = (_a2 = e.get(a)) == null ? void 0 : _a2.candidate;
      f && i.set(f, i.get(f) ?? s++);
    }
  ...
  var Kt = class {
    ...
    set(r, { kind: o, applyFn: e, compounds: i, compoundsWith: s, order: a }) {
      ...
      f ? Object.assign(f, { kind: o, applyFn: e, compounds: i }) : (a === void 0 && (this.lastOrder = this.nextOrder(), a = this.lastOrder), this.variants.set(r, { kind: o, applyFn: e, order: a, compoundsWith: s, compounds: i }));
    }
    nextOrder() {
  ...
  function jr(t) {
    ...
    r.compound("not", 3, (c, p) => {
      ...
      if (j([c], (g, { path: v }) => {
        ...
        return Object.assign(c, M("&", y)), m = true, 1;
      ...
      let m = p.modifier ? `:where(.${t.prefix ? `${t.prefix}\\:` : ""}group\\/${p.modifier.value})` : `:where(.${t.prefix ? `${t.prefix}\\:` : ""}group)`, g = false;
      if (j([c], (v, { path: k }) => {
        if (v.kind !== "rule") return 0;
        for (let y of k.slice(0, -1)) if (y.kind === "rule") return g = false, 2;
        let x = v.selector.replaceAll("&", m);
        U(x, ",").length > 1 && (x = `:is(${x})`), v.selector = `&:is(${x} *)`, g = true;
      }), !g) return null;
    }), r.suggest("group", () => Array.from(r.keys()).filter((c) => r.compoundsWith("group", c))), r.compound("peer", 2, (c, p) => {
      if (p.variant.kind === "arbitrary" && p.variant.relative) return null;
      let m = p.modifier ? `:where(.${t.prefix ? `${t.prefix}\\:` : ""}peer\\/${p.modifier.value})` : `:where(.${t.prefix ? `${t.prefix}\\:` : ""}peer)`, g = false;
      if (j([c], (v, { path: k }) => {
        if (v.kind !== "rule") return 0;
        for (let y of k.slice(0, -1)) if (y.kind === "rule") return g = false, 2;
        let x = v.selector.replaceAll("&", m);
    ...
    o("first", ["&:first-child"]), o("last", ["&:last-child"]), o("only", ["&:only-child"]), o("odd", ["&:nth-child(odd)"]), o("even", ["&:nth-child(even)"]), o("first-of-type", ["&:first-of-type"]), o("last-of-type", ["&:last-of-type"]), o("only-of-type", ["&:only-of-type"]), o("visited", ["&:visited"]), o("target", ["&:target"]), o("open", ["&:is([open], :popover-open, :open)"]), o("default", ["&:default"]), o("checked", ["&:checked"]), o("indeterminate", ["&:indeterminate"]), o("placeholder-shown", ["&:placeholder-shown"]), o("autofill", ["&:autofill"]), o("optional", ["&:optional"]), o("required", ["&:required"]), o("valid", ["&:valid"]), o("invalid", ["&:invalid"]), o("user-valid", ["&:user-valid"]), o("user-invalid", ["&:user-invalid"]), o("in-range", ["&:in-range"]), o("out-of-range", ["&:out-of-range"]), o("read-only", ["&:read-only"]), o("empty", ["&:empty"]), o("focus-within", ["&:focus-within"]), r.static("hover", (c) => {
      ...
      if (j([c], (g, { path: v }) => {
        ...
        for (let k of v.slice(0, -1)) if (k.kind === "rule") return m = false, 2;
        g.selector = `:where(${g.selector.replaceAll("&", "*")}) &`, m = true;
      }), !m) return null;
      ...
      if (j([c], (g, { path: v }) => {
        if (g.kind !== "rule") return 0;
        for (let k of v.slice(0, -1)) if (k.kind === "rule") return m = false, 2;
        g.selector = `&:has(${g.selector.replaceAll("&", "*")})`, m = true;
      }), !m) return null;
    ...
    }, { compounds: 1 }), o("motion-safe", ["@media (prefers-reduced-motion: no-preference)"]), o("motion-reduce", ["@media (prefers-reduced-motion: reduce)"]), o("contrast-more", ["@media (prefers-contrast: more)"]), o("contrast-less", ["@media (prefers-contrast: less)"]);
    {
      ...
      var u = c;
      {
        let p = t.namespace("--breakpoint"), m = new W((g) => {
          switch (g.kind) {
            case "static":
            ...
            case "functional": {
              ...
              let v = null;
              return g.value.kind === "arbitrary" ? v = g.value.value : g.value.kind === "named" && (v = t.resolveValue(g.value.value, ["--breakpoint"])), !v || v.includes("var(") ? null : v;
            }
            case "arbitrary":
            case "compound":
              return null;
      ...
      {
        let p = t.namespace("--container"), m = new W((g) => {
          switch (g.kind) {
            case "functional": {
              if (g.value === null) return null;
              let v = null;
              return g.value.kind === "arbitrary" ? v = g.value.value : g.value.kind === "named" && (v = t.resolveValue(g.value.value, ["--container"])), !v || v.includes("var(") ? null : v;
            }
            case "static":
            case "arbitrary":
            case "compound":
        ...
        r.group(() => {
          ...
          r.functional("@", (g, v) => {
            ...
            if (k === null) return null;
            g.nodes = [F("@container", v.modifier ? `${v.modifier.value} (width >= ${k})` : `(width >= ${k})`, g.nodes)];
          }, { compounds: 1 }), r.functional("@min", (g, v) => {
            let k = m.get(v);
            if (k === null) return null;
            g.nodes = [F("@container", v.modifier ? `${v.modifier.value} (width >= ${k})` : `(width >= ${k})`, g.nodes)];
          }, { compounds: 1 });
  ...
  function Ir(t) {
    let r = Pr(t), o = jr(t), e = new W((u) => br(u, f)), i = new W((u) => Array.from(wr(u, f))), s = new W((u) => {
      let c = Fr(u, f);
      try {
        Ve(c.map(({ node: p }) => p), f);
      } catch {
    ...
    }), f = { theme: t, utilities: r, variants: o, invalidCandidates: /* @__PURE__ */ new Set(), important: false, candidatesToCss(u) {
      let c = [];
      for (let p of u) {
        let m = false, { astNodes: g } = he([p], this, { onInvalidCandidate() {
          m = true;
        } });
  ...
  function he(t, r, { onInvalidCandidate: o } = {}) {
    let e = /* @__PURE__ */ new Map(), i = [], s = /* @__PURE__ */ new Map();
    for (let f of t) {
    ...
    for (let [f, u] of s) {
      ...
      for (let p of u) {
        ...
        if (m.length !== 0) {
          c = true;
          for (let { node: g, propertySort: v } of m) {
            let k = 0n;
            for (let x of p.variants) k |= 1n << BigInt(a.get(x));
            e.set(g, { properties: v, variants: k, candidate: f }), i.push(g);
          }
        }
      }
      c || (o == null ? void 0 : o(f));
  ...
  function Fr(t, r) {
    ...
    for (let s of o) {
      ...
      for (let u of t.variants) if (Ee(f, u, r.variants) === null) return [];
  ...
  function Ee(t, r, o, e = 0) {
    ...
    if (r.kind === "compound") {
      ...
      for (let u of a.nodes) if (u.kind !== "rule" && u.kind !== "at-rule" || i(u, r) === null) return null;
      j(a.nodes, (u) => {
  ...
  function Ki(t, r) {
    ...
    let o = r.utilities.get(t.root) ?? [], e = [], i = o.filter((a) => !Mr(a));
    for (let a of i) {
  ...
  function Br(t) {
    for (let r of t) r.kind !== "at-root" && (r.kind === "declaration" ? r.important = true : (r.kind === "rule" || r.kind === "at-rule") && Br(r.nodes));
  }
  function Li(t) {
    let r = /* @__PURE__ */ new Set(), o = 0, e = t.slice(), i = false;
    for (; e.length > 0; ) {
      let s = e.shift();
  ...
  function Le(t, r) {
    let o = 0, e = G("&", t), i = /* @__PURE__ */ new Set(), s = new W(() => /* @__PURE__ */ new Set()), a = new W(() => /* @__PURE__ */ new Set());
    j([e], (m, { parent: g, path: v }) => {
      if (m.kind === "at-rule") {
        ...
        if (m.name === "@apply") {
          if (g === null) return;
          o |= 1, i.add(g);
          for (let k of Wr(m, r)) for (let x of v) x !== m && i.has(x) && s.get(x).add(k);
        }
      }
    });
    let f = /* @__PURE__ */ new Set(), u = [], c = /* @__PURE__ */ new Set();
    function p(m, g = []) {
      if (!f.has(m)) {
        if (c.has(m)) {
          ...
          throw m.kind === "at-rule" && m.name === "@utility" && v.kind === "at-rule" && v.name === "@utility" && j(m.nodes, (k) => {
            ...
            for (let y of x) for (let $ of r.parseCandidate(y)) switch ($.kind) {
              case "arbitrary":
                break;
              case "static":
              case "functional":
...
${le([v])}`);
        ...
        c.add(m);
        for (let v of s.get(m)) for (let k of a.get(v)) g.push(m), p(k, g), g.pop();
        f.add(m), c.delete(m), u.push(m);
      }
    }
    for (let m of i) p(m);
    for (let m of u) "nodes" in m && j(m.nodes, (g, { replaceWith: v }) => {
      if (g.kind !== "at-rule" || g.name !== "@apply") return;
      let k = g.params.split(/(\s+)/g), x = {}, y = 0;
      for (let [$, b] of k.entries()) $ % 2 === 0 && (x[b] = y), y += b.length;
      {
        let $ = Object.keys(x), b = he($, r, { onInvalidCandidate: (P) => {
          ...
          if (D.length > 1) {
            ...
            if (r.candidatesToCss([_])[0]) {
              let H = r.candidatesToCss(D.map((B) => `${B}:[--tw-variant-check:1]`)), L = D.filter((B, J) => H[J] === null);
              if (L.length > 0) {
                if (L.length === 1) throw new Error(`Cannot apply utility class \`${P}\` because the ${L.map((B) => `\`${B}\``)} variant does not exist.`);
                {
                  let B = new Intl.ListFormat("en", { style: "long", type: "conjunction" });
        ...
        } }), V = g.src, R = b.astNodes.map((P) => {
          var _a2;
          let D = (_a2 = b.nodeSorting.get(P)) == null ? void 0 : _a2.candidate, _ = D ? x[D] : void 0;
        ...
        for (let P of R) if (P.kind === "rule") for (let D of P.nodes) K.push(D);
        else K.push(P);
        v(K);
      }
    });
  ...
  function* Wr(t, r) {
    for (let o of t.params.split(/\s+/g)) for (let e of r.parseCandidate(o)) switch (e.kind) {
      case "arbitrary":
        break;
      case "static":
      case "functional":
    ...
    return j(t, (f, { replaceWith: u }) => {
      if (f.kind === "at-rule" && (f.name === "@import" || f.name === "@reference")) {
        ...
        return a.push((async () => {
          ...
          let x = await o(p, r), y = Ne(x.content, { from: i ? x.path : void 0 });
          await It(y, x.base, o, e + 1, i), k.nodes = Ii(f, [ue({ base: x.base }, y)], m, g, v);
        })()), u(k), 1;
      }
  ...
  function Fi(t) {
    ...
    return Hr(t, [], (o, e) => {
      ...
      if (Wi(o)) {
        r.push([e, o[0]]);
        for (let i of Reflect.ownKeys(o[1])) r.push([[...e, `-${i}`], o[1][i]]);
        return 1;
      }
      if (Array.isArray(o) && o.every((i) => typeof i == "string")) return e[0] === "fontSize" ? (r.push([e, o[0]]), o.length >= 2 && r.push([[...e, "-line-height"], o[1]])) : r.push([e, o.join(", ")]), 1;
    }), r;
  }
  var Mi = /^[a-zA-Z0-9-_%/\.]+$/;
  function ut(t) {
    ...
    for (let r of t) if (!Mi.test(r)) return null;
  ...
  function ft(t, r, o) {
    return function(i, s) {
      ...
      let u = (() => {
        var _a2;
        let c = ct(i), [p, m] = qi(t.theme, c), g = o(Gr(r() ?? {}, c) ?? null);
        ...
        if (g !== null && typeof g == "object" && !Array.isArray(g)) {
          ...
          for (let k in p) k !== "__CSS_VALUES__" && (((_a2 = g == null ? void 0 : g.__CSS_VALUES__) == null ? void 0 : _a2[k]) & 4 && Gr(v, k.split("-")) !== void 0 || (v[ve(k)] = p[k]));
          return v;
        }
  ...
  function qi(t, r) {
    ...
    let o = ut(r), e = /* @__PURE__ */ new Map(), i = new W(() => /* @__PURE__ */ new Map()), s = t.namespace(`--${o}`);
    ...
    for (let [p, m] of s) {
      ...
      let g = p.indexOf("--"), v = p.slice(0, g), k = p.slice(g + 2);
    ...
    return r[r.length - 1] === "DEFAULT" ? [(u == null ? void 0 : u.DEFAULT) ?? null, c.DEFAULT ?? 0] : "DEFAULT" in u && Object.keys(u).length === 1 ? [u.DEFAULT, c.DEFAULT ?? 0] : (u.__CSS_VALUES__ = c, [u, c]);
  }
  function Gr(t, r) {
  ...
  var Zr = 92, Ji = 93, Jr = 41, Qi = 58, Qr = 44, Xi = 34, en = 46, Xr = 62, eo = 10, tn = 35, to = 91, ro = 40, oo = 43, rn = 39, io = 32, no = 9, lo = 126;
  function dt(t) {
    t = t.replaceAll(`\r
`, `
`);
    ...
    for (let a = 0; a < t.length; a++) {
      ...
      switch (f) {
        ...
        case lo: {
          ...
          let u = a, c = a + 1;
          for (; c < t.length && (s = t.charCodeAt(c), !(s !== Qr && s !== Xr && s !== eo && s !== io && s !== oo && s !== no && s !== lo)); c++) ;
          a = c - 1;
          let p = t.slice(u, c), m = p.trim() === "," ? Yi(p) : Hi(p);
        ...
        case Xi: {
          let u = a;
          for (let c = a + 1; c < t.length; c++) if (s = t.charCodeAt(c), s === Zr) c += 1;
          else if (s === f) {
            a = c;
            break;
          }
  ...
  function Ft({ designSystem: t, ast: r, resolvedConfig: o, featuresRef: e, referenceMode: i }) {
    let s = { addBase(a) {
      ...
      }, { compounds: Ae(typeof f == "string" ? [f] : f) }) : typeof f == "object" && t.variants.fromAst(a, ce(f));
    }, matchVariant(a, f, u) {
      function c(m, g, v) {
        let k = f(m, { modifier: (g == null ? void 0 : g.value) ?? null });
        return so(k, v);
      }
      try {
        let m = f("a", { modifier: null });
        if (typeof m == "string" && m.includes(":merge(")) return;
        if (Array.isArray(m) && m.some((g) => g.includes(":merge("))) return;
      } catch {
      }
      let p = Object.keys((u == null ? void 0 : u.values) ?? {});
      t.variants.group(() => {
        t.variants.functional(a, (m, g) => {
          if (!g.value) {
            if ((u == null ? void 0 : u.values) && "DEFAULT" in u.values) {
          ...
          else if (g.value.kind === "named" && (u == null ? void 0 : u.values)) {
        ...
        let v = m.value ? m.value.value : "DEFAULT", k = g.value ? g.value.value : "DEFAULT", x = ((_a2 = u == null ? void 0 : u.values) == null ? void 0 : _a2[v]) ?? v, y = ((_b = u == null ? void 0 : u.values) == null ? void 0 : _b[k]) ?? k;
        if (u && typeof u.sort == "function") return u.sort({ value: x, modifier: ((_c = m.modifier) == null ? void 0 : _c.value) ?? null }, { value: y, modifier: ((_d = g.modifier) == null ? void 0 : _d.value) ?? null });
        let $ = p.indexOf(v), b = p.indexOf(k);
      ...
      for (let [c, p] of f) {
        ...
        if (Fe(m, (v) => {
          if (v.kind === "selector" && v.value[0] === "." && ao.test(v.value.slice(1))) {
            let k = v.value;
            v.value = "&";
            let x = Me(m), y = k.slice(1), $ = x === "&" ? ce(p) : [G(x, ce(p))];
            u.get(y).push(...$), g = true, v.value = k;
            return;
          }
      ...
      let u = (f == null ? void 0 : f.type) ? Array.isArray(f == null ? void 0 : f.type) ? f.type : [f.type] : ["any"];
      for (let [p, m] of Object.entries(a)) {
        let g = function({ negative: v }) {
          return (k) => {
            var _a2, _b;
            if (((_a2 = k.value) == null ? void 0 : _a2.kind) === "arbitrary" && u.length > 0 && !u.includes("any") && (k.value.dataType && !u.includes(k.value.dataType) || !k.value.dataType && !Y(k.value.value, u))) return;
            let x = u.includes("color"), y = null, $ = false;
            {
              let R = (f == null ? void 0 : f.values) ?? {};
              x && (R = Object.assign({ inherit: "inherit", transparent: "transparent", current: "currentcolor" }, R)), k.value ? k.value.kind === "arbitrary" ? y = k.value.value : k.value.fraction && R[k.value.fraction] ? (y = R[k.value.fraction], $ = true) : R[k.value.value] ? y = R[k.value.value] : R.__BARE_VALUE__ && (y = R.__BARE_VALUE__(k.value) ?? null, $ = (k.value.fraction !== null && (y == null ? void 0 : y.includes("/"))) ?? false) : y = R.DEFAULT ?? null;
            }
            if (y === null) return;
            let b;
            {
              let R = (f == null ? void 0 : f.modifiers) ?? null;
              k.modifier ? R === "any" || k.modifier.kind === "arbitrary" ? b = k.modifier.value : (R == null ? void 0 : R[k.modifier.value]) ? b = R[k.modifier.value] : x && !Number.isNaN(Number(k.modifier.value)) ? b = `${k.modifier.value}%` : b = null : b = null;
            }
            if (k.modifier && b === null && !$) return ((_b = k.value) == null ? void 0 : _b.kind) === "arbitrary" ? null : void 0;
            x && b !== null && (y = Q(y, b)), v && (y = `calc(${y} * -1)`);
            let V = ce(m(y, { modifier: b }));
        ...
        (f == null ? void 0 : f.supportsNegativeValues) && t.utilities.functional(`-${p}`, g({ negative: true }), { types: u }), t.utilities.functional(p, g({ negative: false }), { types: u }), t.utilities.suggest(p, () => {
          let v = (f == null ? void 0 : f.values) ?? {}, k = new Set(Object.keys(v));
          k.delete("__BARE_VALUE__"), k.has("DEFAULT") && (k.delete("DEFAULT"), k.add(null));
          let x = (f == null ? void 0 : f.modifiers) ?? {}, y = x === "any" ? [] : Object.keys(x);
          return [{ supportsNegative: (f == null ? void 0 : f.supportsNegativeValues) ?? false, values: Array.from(k), modifiers: y }];
        });
      }
    }, addComponents(a, f) {
    ...
    }, theme: ft(t, () => o.theme ?? {}, (a) => a), prefix(a) {
      return a;
    }, config(a, f) {
      let u = o;
      if (!a) return u;
  ...
  function ce(t) {
    ...
    for (let [e, i] of o) if (typeof i != "object") {
      if (!e.startsWith("--")) {
        if (i === "@slot") {
          r.push(G(e, [F("@slot")]));
          continue;
      ...
      r.push(l(e, String(i)));
    } else if (Array.isArray(i)) for (let s of i) typeof s == "string" ? r.push(l(e, s)) : r.push(G(e, ce(s)));
  ...
  function Mt(t, { config: r, base: o, path: e, reference: i }) {
    let s = [];
    for (let u of r.plugins ?? []) "__isOptionsFunction" in u ? s.push({ ...u(), reference: i }) : "handler" in u ? s.push({ ...u, reference: i }) : s.push({ handler: u, reference: i });
    ...
    for (let u of r.presets ?? []) Mt(t, { path: e, base: o, config: u, reference: i });
    for (let u of s) t.plugins.push(u), u.config && Mt(t, { path: e, base: o, config: u.config, reference: !!u.reference });
    let a = r.content ?? [], f = Array.isArray(a) ? a : a.files;
    for (let u of f) t.content.files.push(typeof u == "object" ? u : { base: o, pattern: u });
    t.configs.push(r);
  }
  function un(t) {
    var _a2;
    let r = /* @__PURE__ */ new Set(), o = ft(t.design, () => t.theme, i), e = Object.assign(o, { theme: o, colors: pt });
    function i(s) {
    ...
    for (let s of t.configs) {
      ...
      for (let u in f) (_a2 = t.extend)[u] ?? (_a2[u] = []), t.extend[u].push(f[u]);
    }
  ...
  function cn({ center: t, padding: r, screens: o }, e) {
    let i = [], s = null;
    ...
    if (typeof r == "object" && r !== null) {
      ...
      for (let [f, , u] of a) if (s && s.has(f)) s.get(f).nodes.push(l("padding-inline", u));
      else {
        if (s) continue;
        i.push(F("@media", `(width >= theme(--breakpoint-${f}))`, [l("padding-inline", u)]));
      }
    }
    if (s) for (let [, a] of s) i.push(a);
    return i;
  }
  function ko({ addVariant: t, config: r }) {
    let o = r("darkMode", null), [e, i = ".dark"] = Array.isArray(o) ? o : [o];
    if (e === "variant") {
      let s;
      if (Array.isArray(i) || typeof i == "function" ? s = i : typeof i == "string" && (s = [i]), Array.isArray(s)) for (let a of s) a === ".dark" ? (e = false, console.warn('When using `variant` for `darkMode`, you must provide a selector.\nExample: `darkMode: ["variant", ".your-selector &"]`')) : a.includes("&") || (e = false, console.warn('When using `variant` for `darkMode`, your selector must contain `&`.\nExample `darkMode: ["variant", ".your-selector &"]`'));
      i = s;
    }
    e === null || (e === "selector" ? t("dark", `&:where(${i}, ${i} *)`) : e === "media" ? t("dark", "@media (prefers-color-scheme: dark)") : e === "variant" ? t("dark", i) : e === "class" && t("dark", `&:is(${i} *)`));
  }
  function vo(t) {
    for (let [r, o] of [["t", "top"], ["tr", "top right"], ["r", "right"], ["br", "bottom right"], ["b", "bottom"], ["bl", "bottom left"], ["l", "left"], ["tl", "top left"]]) t.utilities.static(`bg-gradient-to-${r}`, () => [l("--tw-gradient-position", `to ${o} in oklab`), l("background-image", "linear-gradient(var(--tw-gradient-stops))")]);
  ...
  function wo(t, r) {
    var _a2;
    let o = t.theme.screens || {}, e = ((_a2 = r.variants.get("min")) == null ? void 0 : _a2.order) ?? 0, i = [];
  ...
  function bo(t, r) {
    ...
    if (Object.keys(o).length > 0) {
      let s = r.variants.get("aria"), a = s == null ? void 0 : s.applyFn, f = s == null ? void 0 : s.compounds;
      r.variants.functional("aria", (u, c) => {
        let p = c.value;
        return p && p.kind === "named" && p.value in o ? a == null ? void 0 : a(u, { ...c, value: { kind: "arbitrary", value: o[p.value] } }) : a == null ? void 0 : a(u, c);
      }, { compounds: f });
    }
    if (Object.keys(e).length > 0) {
      let s = r.variants.get("supports"), a = s == null ? void 0 : s.applyFn, f = s == null ? void 0 : s.compounds;
      r.variants.functional("supports", (u, c) => {
        let p = c.value;
        return p && p.kind === "named" && p.value in e ? a == null ? void 0 : a(u, { ...c, value: { kind: "arbitrary", value: e[p.value] } }) : a == null ? void 0 : a(u, c);
      }, { compounds: f });
    }
    if (Object.keys(i).length > 0) {
      let s = r.variants.get("data"), a = s == null ? void 0 : s.applyFn, f = s == null ? void 0 : s.compounds;
      r.variants.functional("data", (u, c) => {
        let p = c.value;
        return p && p.kind === "named" && p.value in i ? a == null ? void 0 : a(u, { ...c, value: { kind: "arbitrary", value: i[p.value] } }) : a == null ? void 0 : a(u, c);
      }, { compounds: f });
    }
  }
  var dn = /^[a-z]+$/;
  async function xo({ designSystem: t, base: r, ast: o, loadModule: e, sources: i }) {
    let s = 0, a = [], f = [];
    j(o, (m, { parent: g, replaceWith: v, context: k }) => {
      if (m.kind === "at-rule") {
        if (m.name === "@plugin") {
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
        ...
        if (m.name === "@config") {
          ...
          f.push({ id: m.params.slice(1, -1), base: k.base, reference: !!k.reference }), v([]), s |= 4;
          return;
        }
      }
    }), vo(t);
    ...
    if (t.resolveThemeValue = function(g, v) {
      return g.startsWith("--") ? u(g, v) : (s |= yo({ designSystem: t, base: r, ast: o, sources: i, configs: [], pluginDetails: [] }), t.resolveThemeValue(g, v));
    }, !a.length && !f.length) return 0;
    let [c, p] = await Promise.all([Promise.all(f.map(async ({ id: m, base: g, reference: v }) => {
      let k = await e(m, g, "config");
      return { path: m, base: k.base, config: k.module, reference: v };
    })), Promise.all(a.map(async ([{ id: m, base: g, reference: v }, k]) => {
      let x = await e(m, g, "plugin");
      return { path: m, base: x.base, plugin: x.module, options: k, reference: v };
    }))]);
    return s |= yo({ designSystem: t, base: r, ast: o, sources: i, configs: c, pluginDetails: p }), s;
  }
  function yo({ designSystem: t, base: r, ast: o, sources: e, configs: i, pluginDetails: s }) {
    let a = 0, u = [...s.map((y) => {
      if (!y.options) return { config: { plugins: [y.plugin] }, base: y.base, reference: y.reference };
      if ("__isOptionsFunction" in y.plugin) return { config: { plugins: [y.plugin(y.options)] }, base: y.base, reference: y.reference };
      throw new Error(`The plugin "${y.path}" does not accept options`);
    }), ...i], { resolvedConfig: c } = Bt(t, [{ config: go(t.theme), base: r, reference: true }, ...u, { config: { plugins: [ko] }, base: r, reference: true }]), { resolvedConfig: p, replacedThemeKeys: m } = Bt(t, u), g = t.resolveThemeValue;
    ...
    for (let { handler: y, reference: $ } of c.plugins) $ ? (x || (x = Ft({ ...v, referenceMode: true })), y(x)) : y(k);
    ...
    if (!t.important && c.important === true && (t.important = true), typeof c.important == "string") {
      let y = c.important;
      j(o, ($, { replaceWith: b, parent: V }) => {
        if ($.kind === "at-rule" && !($.name !== "@tailwind" || $.params !== "utilities")) return (V == null ? void 0 : V.kind) === "rule" && V.selector === y ? 2 : (b(M(y, [$])), 2);
      });
    }
...
This feature is not currently supported.`);
      let $ = false;
      y.pattern[0] == "!" && ($ = true, y.pattern = y.pattern.slice(1)), e.push({ ...y, negated: $ });
    }
    return a;
  }
  function Ao(t) {
  ...
  function Co({ ast: t }) {
    let r = new W((i) => Ao(i.code)), o = new W((i) => ({ url: i.file, content: i.code, ignore: false })), e = { file: null, sources: [], mappings: [] };
    j(t, (i) => {
...
`)) {
      ...
      let p = a.find(i.src[2]), m = f.find(i.dst[2]);
      e.mappings.push({ name: null, originalPosition: { source: s, ...p }, generatedPosition: m });
    });
    for (let i of r.keys()) e.sources.push(o.get(i));
    return e.mappings.sort((i, s) => {
      var _a2, _b, _c, _d;
      return i.generatedPosition.line - s.generatedPosition.line || i.generatedPosition.column - s.generatedPosition.column || (((_a2 = i.originalPosition) == null ? void 0 : _a2.line) ?? 0) - (((_b = s.originalPosition) == null ? void 0 : _b.line) ?? 0) || (((_c = i.originalPosition) == null ? void 0 : _c.column) ?? 0) - (((_d = s.originalPosition) == null ? void 0 : _d.column) ?? 0);
    }), e;
  }
  var No = /^(-?\d+)\.\.(-?\d+)(?:\.\.(-?\d+))?$/;
  function gt(t) {
    ...
    let p = gt(u);
    for (let m of p) for (let g of c) o.push(e + g + m);
    return o;
  }
  function pn(t) {
    return No.test(t);
  ...
  async function wn(t, { base: r = "", from: o, loadModule: e = hn, loadStylesheet: i = kn } = {}) {
    let s = 0;
    t = [ue({ base: r }, t)], s |= await It(t, r, i, 0, o !== void 0);
    let a = null, f = new Je(), u = [], c = [], p = null, m = null, g = [], v = [], k = [], x = [], y = null;
    j(t, (b, { parent: V, replaceWith: R, context: K }) => {
      if (b.kind === "at-rule") {
        if (b.name === "@tailwind" && (b.params === "utilities" || b.params.startsWith("utilities"))) {
          ...
          for (let D of P) if (D.startsWith("source(")) {
            ...
            y = { base: K.sourceBase ?? K.base, pattern: _.slice(1, -1) };
          }
          m = b, s |= 16;
        }
        if (b.name === "@utility") {
        ...
        if (b.name === "@source") {
          ...
          let P = false, D = false, _ = b.params;
          if (_[0] === "n" && _.startsWith("not ") && (P = true, _ = _.slice(4)), _[0] === "i" && _.startsWith("inline(") && (D = true, _ = _.slice(7, -1)), _[0] === '"' && _[_.length - 1] !== '"' || _[0] === "'" && _[_.length - 1] !== "'" || _[0] !== "'" && _[0] !== '"') throw new Error("`@source` paths must be quoted.");
          let H = _.slice(1, -1);
          if (D) {
            let L = P ? x : k, B = U(H, " ");
            for (let J of B) for (let ie of gt(J)) L.push(ie);
          } else v.push({ base: K.base, pattern: H, negated: P });
          R([]);
          return;
        }
        ...
        if (b.name === "@media") {
          ...
          for (let _ of P) if (_.startsWith("source(")) {
            let H = _.slice(7, -1);
            j(b.nodes, (L, { replaceWith: B }) => {
              if (L.kind === "at-rule" && L.name === "@tailwind" && L.params === "utilities") return L.params += ` source(${H})`, B([ue({ sourceBase: K.base }, [L])]), 2;
            });
          ...
          } else _ === "important" ? a = true : _ === "reference" ? b.nodes = [ue({ reference: true }, b.nodes)] : D.push(_);
...
${H}`);
    ...
    let $ = Ir(f);
    if (a && ($.important = a), x.length > 0) for (let b of x) $.invalidCandidates.add(b);
    s |= await xo({ designSystem: $, base: r, ast: t, loadModule: e, sources: v });
    for (let b of u) b($);
    for (let b of c) b($);
    if (p) {
      let b = [];
      ...
      for (let R of V) t.push(ue({ theme: true }, [I([R])]));
      p.nodes = [ue({ theme: true }, b)];
    }
    if (g.length > 0) {
      for (let b of g) {
        let V = M("&", b.nodes), R = b.params, K = $.parseVariant(R);
    ...
    return j(t, (b, { replaceWith: V }) => {
      if (b.kind === "at-rule") return b.name === "@utility" && V([]), 1;
    }), { designSystem: $, ast: t, sources: v, root: y, utilitiesNode: m, features: s, inlineCandidates: k };
  }
  async function bn(t, r = {}) {
    let { designSystem: o, ast: e, sources: i, root: s, utilitiesNode: a, features: f, inlineCandidates: u } = await wn(t, r);
    e.unshift(Ze(`! tailwindcss v${Gt} | MIT License | https://tailwindcss.com `));
    function c(k) {
      o.invalidCandidates.add(k);
    }
    let p = /* @__PURE__ */ new Set(), m = null, g = 0, v = false;
    for (let k of u) o.invalidCandidates.has(k) || (p.add(k), v = true);
    return { sources: i, root: s, features: f, build(k) {
      if (f === 0) return t;
      if (!a) return m ?? (m = be(e, o, r.polyfills)), m;
      let x = v, y = false;
      v = false;
      let $ = p.size;
      for (let V of k) if (!o.invalidCandidates.has(V)) if (V[0] === "-" && V[1] === "-") {
        let R = o.theme.markUsedVariable(V);
        x || (x = R), y || (y = R);
      } else p.add(V), x || (x = p.size !== $);
      if (!x) return m ?? (m = be(e, o, r.polyfills)), m;
      let b = he(p, o, { onInvalidCandidate: c }).astNodes;
      return r.from && j(b, (V) => {
        V.src ?? (V.src = a.src);
      }), !y && g === b.length ? (m ?? (m = be(e, o, r.polyfills)), m) : (g = b.length, a.nodes = b, m = be(e, o, r.polyfills), m);
    } };
  }
  async function So(t, r = {}) {
    let o = Ne(t, { from: r.from }), e = await bn(o, r), i = o, s = t;
    return { ...e, build(a) {
      let f = e.build(a);
...
`;
  var Be = { index: $o, preflight: Vo, theme: Eo, utilities: To };
  var ht = class {
    start(r) {
  ...
  var Po = "text/tailwindcss", kt, qt = /* @__PURE__ */ new Set(), Wt = "", Ht = document.createElement("style"), Ro = Promise.resolve(), $n = 1, re = new ht();
  async function Vn() {
    re.start("Create compiler"), re.start("Reading Stylesheets");
    let t = document.querySelectorAll(`style[type="${Po}"]`), r = "";
    for (let o of t) Oo(o), r += o.textContent + `
`;
    if (r.includes("@import") || (r = `@import "tailwindcss";${r}`), re.end("Reading Stylesheets", { size: r.length, changed: Wt !== r }), Wt !== r) {
      Wt = r, re.start("Compile CSS");
      try {
        kt = await So(r, { base: "/", loadStylesheet: En, loadModule: Tn });
      } finally {
  ...
  async function En(t, r) {
    function o() {
      if (t === "tailwindcss") return { path: "virtual:tailwindcss/index.css", base: r, content: Be.index };
      if (t === "tailwindcss/preflight" || t === "tailwindcss/preflight.css" || t === "./preflight.css") return { path: "virtual:tailwindcss/preflight.css", base: r, content: Be.preflight };
      if (t === "tailwindcss/theme" || t === "tailwindcss/theme.css" || t === "./theme.css") return { path: "virtual:tailwindcss/theme.css", base: r, content: Be.theme };
      if (t === "tailwindcss/utilities" || t === "tailwindcss/utilities.css" || t === "./utilities.css") return { path: "virtual:tailwindcss/utilities.css", base: r, content: Be.utilities };
  ...
  async function Rn(t) {
    ...
    for (let o of document.querySelectorAll("[class]")) for (let e of o.classList) qt.has(e) || (qt.add(e), r.add(e));
    re.end("Collect classes", { count: r.size }), !(r.size === 0 && t === "incremental") && (re.start("Build utilities"), Ht.textContent = kt.build(Array.from(r)), re.end("Build utilities"));
  }
  function vt(t) {
    async function r() {
      if (!kt && t !== "full") return;
  ...
  function Oo(t) {
    Pn.observe(t, { attributes: true, attributeFilter: ["type"], characterData: true, subtree: true, childList: true });
  }
...
//# sourceMappingURL=@tailwindcss_browser.js.map
